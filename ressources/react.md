...
- [Tuto redux](https://egghead.io/lessons/javascript-redux-the-single-immutable-state-tree)
- [Hello world typescript + JSX, compilation](http://staxmanade.com/2015/08/playing-with-typescript-and-jsx/)

## Documentations
- [Documentation de fou sur React et Typescript par le copain basarat](https://basarat.gitbooks.io/typescript/content/docs/jsx/tsx.html)
- [Typescript et JSX, doc par microsoft](https://github.com/Microsoft/TypeScript/wiki/JSX)
...
## Alternatives
- [Librairie à la React qui à l'air bien cool](http://riotjs.com/)